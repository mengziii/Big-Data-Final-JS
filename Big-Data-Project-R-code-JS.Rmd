...
confusionMatrix(model_DT_tfidf_5$pred[order(model_DT_tfidf_5$pred$rowIndex),2], m_tfidf$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_DT_tfidf$pred[order(model_DT_tfidf$pred$rowIndex),2], m_tfidf$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_DT_bow_5$pred[order(model_DT_bow_5$pred$rowIndex),2], m_bow$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_DT_bow$pred[order(model_DT_bow$pred$rowIndex),2], m_bow$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_DT_uni_5$pred[order(model_DT_uni_5$pred$rowIndex),2], m_uni$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_DT_uni$pred[order(model_DT_uni$pred$rowIndex),2], m_uni$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_RF_tfidf_5$pred[order(model_RF_tfidf_5$pred$rowIndex),2], m_tfidf$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_RF_tfidf$pred[order(model_RF_tfidf$pred$rowIndex),2], m_tfidf$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_RF_tfidf_50$pred[order(model_RF_tfidf_50$pred$rowIndex),2], m_tfidf$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_RF_bow_5$pred[order(model_RF_bow_5$pred$rowIndex),2], m_bow$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_RF_bow$pred[order(model_RF_bow$pred$rowIndex),2], m_bow$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_RF_bow_50$pred[order(model_RF_bow_50$pred$rowIndex),2], m_bow$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_RF_uni_5$pred[order(model_RF_uni_5$pred$rowIndex),2], m_uni$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_RF_uni$pred[order(model_RF_uni$pred$rowIndex),2], m_uni$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_RF_uni_50$pred[order(model_RF_uni_50$pred$rowIndex),2], m_uni$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_NB_tfidf_5$pred[order(model_NB_tfidf_5$pred$rowIndex),2], m_tfidf$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_NB_tfidf$pred[order(model_NB_tfidf$pred$rowIndex),2], m_tfidf$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_NB_bow_5$pred[order(model_NB_bow_5$pred$rowIndex),2], m_bow$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_NB_bow$pred[order(model_NB_bow$pred$rowIndex),2], m_bow$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_NB_uni_5$pred[order(model_NB_uni_5$pred$rowIndex),2], m_uni$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_NB_uni$pred[order(model_NB_uni$pred$rowIndex),2], m_uni$class)
...
tweets_m_bi <- as.matrix(tweets_dtm_bi)
dim(tweets_m_bi)
...
# Reduce the matrix by removing the low frequency terms
tweets_dtm_bi_sparse <- removeSparseTerms(tweets_dtm_bi, 0.99) 
tweets_dtm_bi_sparse

tweets_m_bi <- as.matrix(tweets_dtm_bi_sparse)
dim(tweets_m_bi)
...
pred_RF_bi$equal <- ifelse(pred_RF_bi$pred == pred_NB_bi$obs, 1, 0)
...
#create a confusion matrix for the best fold
confusionMatrix(model_RF_bi_50$pred[order(model_RF_bi_50$pred$rowIndex),2],
