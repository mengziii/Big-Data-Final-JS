...
#create a confusion matrix for the best fold
confusionMatrix(model_NB_tfidf_5$pred[order(model_NB_tfidf_5$pred$rowIndex),4], m_tfidf$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_NB_tfidf$pred[order(model_NB_tfidf$pred$rowIndex),4], m_tfidf$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_NB_bow_5$pred[order(model_NB_bow_5$pred$rowIndex),4], m_bow$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_NB_bow$pred[order(model_NB_bow$pred$rowIndex),4], m_bow$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_NB_uni_5$pred[order(model_NB_uni_5$pred$rowIndex),4], m_uni$class)
...
#create a confusion matrix for the best fold
confusionMatrix(model_NB_uni$pred[order(model_NB_uni$pred$rowIndex),4], m_uni$class)
